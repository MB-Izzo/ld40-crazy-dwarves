...
public class GoTo : IState {
	...
	{
        // TODO: Time Manager.
		_owner_gameobject.transform.position = Vector3.MoveTowards(_owner_gameobject.transform.position, new Vector3(_destination_pos.x, 0.5f, _destination_pos.z), _speed * Time.deltaTime);
